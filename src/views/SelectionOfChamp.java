...
public class SelectionOfChamp extends JFrame implements ActionListener , MouseListener{
	...
	private ArrayList<Champion> tmp = new ArrayList<>();
     ...
     public SelectionOfChamp(ArrayList<Champion> c) {
    	 tmp = c;
      setTitle("Marvel");
      setBounds(150,40, 1240,800);
   	  setDefaultCloseOperation(EXIT_ON_CLOSE);
   	   ...
   	   ch.setLayout(new GridLayout(1,3,0,0));
   	   ch.setPreferredSize(new Dimension(0,180));
	  ...
	  firstname = JOptionPane.showInputDialog("Enter the First Player name ","Player 1");
...
//		  start.add(x);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==ready) {
			this.dispose();
			new SelectionOfChamp2(tmp,firstname,this.getFirstLeader(), this.getFirstTeam() ,FirstTeamButtons , FirstSelection);
			JOptionPane.showMessageDialog(null," SecondPlayer please choose 3 Champions !", "Friendly Notice ",JOptionPane.PLAIN_MESSAGE );
...
//						FirstTeam.add(tmp.get(k));
//						buttons.get(k).setEnabled(false);
//						buttons.remove(k);
//						break;	
//					}
//					 if(s2.getIcon()==null ) {
//						if(buttons.get(k)!=b1 || buttons.get(k)!=b2) {
...
//			}
		...
		if(s1.getIcon()==null) {
			if(e.getSource().equals(b1) && f1 !=true) {
				f1=true;
				s1.setIcon(b1.getIcon());
				FirstTeam.add(tmp.get(0));
				b1.setEnabled(false);
			}
			else if(e.getSource().equals(b2) && f2!=true) {
				f2=true;
				s1.setIcon(b2.getIcon());
				FirstTeam.add(tmp.get(1));
				b2.setEnabled(false);
			}
			else if(e.getSource().equals(b3) && f3!=true) {
				f3=true;
				s1.setIcon(b3.getIcon());
				FirstTeam.add(tmp.get(2));
				b3.setEnabled(false);
			}
			else if(e.getSource().equals(b4) && f4!=true) {
				f4=true;
				s1.setIcon(b4.getIcon());
				FirstTeam.add(tmp.get(3));
				b4.setEnabled(false);
			}
			else if(e.getSource().equals(b5)&& f5!=true) {
				f5=true;
				s1.setIcon(b5.getIcon());
				FirstTeam.add(tmp.get(4));
				b5.setEnabled(false);
			}
			else if(e.getSource().equals(b6) &&f6!=true ) {
				f6=true;
				s1.setIcon(b6.getIcon());
				FirstTeam.add(tmp.get(5));
				b6.setEnabled(false);
			}
			else if(e.getSource().equals(b7)&& f7!=true) {
				f7=true;
				s1.setIcon(b7.getIcon());
				FirstTeam.add(tmp.get(6));
				b7.setEnabled(false);
			}
			else if(e.getSource().equals(b8)&& f8!=true) {
				f8=true;
				s1.setIcon(b8.getIcon());
				FirstTeam.add(tmp.get(7));
				b8.setEnabled(false);
			}
			else if(e.getSource().equals(b9)&& f9!=true) {
				f9=true;
				s1.setIcon(b9.getIcon());
				FirstTeam.add(tmp.get(8));
				b9.setEnabled(false);
			}
			else if(e.getSource().equals(b10)&& f10!=true) {
				f10=true;
				s1.setIcon(b10.getIcon());
				FirstTeam.add(tmp.get(9));
				b10.setEnabled(false);
			}
			else if(e.getSource().equals(b11) && f11!=true) {
				f11=true;
				s1.setIcon(b11.getIcon());
				FirstTeam.add(tmp.get(10));
				b11.setEnabled(false);
			}
			else if(e.getSource().equals(b12)&& f12!=true) {
				f12=true;
				s1.setIcon(b12.getIcon());
				FirstTeam.add(tmp.get(11));
				b12.setEnabled(false);
			}
			else if(e.getSource().equals(b13)&& f13!=true) {
				f13=true;
				s1.setIcon(b13.getIcon());
				FirstTeam.add(tmp.get(12));
				b13.setEnabled(false);
			}
			else if(e.getSource().equals(b14)&& f14!=true) {
				f14=true;
				s1.setIcon(b14.getIcon());
				FirstTeam.add(tmp.get(13));
				b14.setEnabled(false);
			}
			else if(e.getSource().equals(b15)&& f15!=true) {
				f15=true;
				s1.setIcon(b15.getIcon());
				FirstTeam.add(tmp.get(14));
		...
		if(s2.getIcon()==null ) {
			...
			if(f==false && s3.getIcon()!=null) {
				if(e.getSource().equals(s1) && r==false) {
					r=true;
					ready.setEnabled(true);
					s1.setBorder(new LineBorder(Color.RED,7));
					FirstLeader = FirstTeam.get(0);
					f = true;
					return;
				}
				 if(e.getSource().equals(s2) && r==false) {
					r=true;
					ready.setEnabled(true);
					s2.setBorder(new LineBorder(Color.RED,7));
					FirstLeader = FirstTeam.get(1);
					f = true;
					return;
				}
				if(e.getSource().equals(s3)&& r==false) {
					r=true;
					ready.setEnabled(true);
					s3.setBorder(new LineBorder(Color.RED,7));
					FirstLeader = FirstTeam.get(2);
					f = true;
					return;
				}
				}
			FirstTeamButtons.add(s1);
			FirstTeamButtons.add(s2);
			FirstTeamButtons.add(s3);
